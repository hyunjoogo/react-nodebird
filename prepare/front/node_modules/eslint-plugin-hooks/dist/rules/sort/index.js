        ...
        return {
            Program: function (_a) {
                ...
                body
                    ...
                    var hooks = nodes === null || nodes === void 0 ? void 0 : nodes.map(function (_a) {
                        ...
                        return (type === 'CallExpression'
                            ...
                            : type === 'VariableDeclarator'
                                ? [type, init]
                                : []);
                    }).filter(function (node) { return node.length; }).map(function (_a) {
                        var _b;
                    ...
                    }).filter(Boolean).filter(function (hook) { var _a; return ((_a = hook.name) === null || _a === void 0 ? void 0 : _a.slice(0, 3)) === 'use' && groups.includes(hook.name); });
                    ...
                    hooks.forEach(function (hook, idx) {
                        ...
                        if (noMatching()) {
                            ctx.report(hook, "Non-matching declaration order. " + hook.name + " comes " + (!idx ? 'after' : 'before') + " " + correctOrdering[idx].name + ".");
                        }
                    });
                });
            },
